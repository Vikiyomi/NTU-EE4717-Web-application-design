...
function checkbox2(){
    if (document.getElementById("quantity").checked){
...
<div id="wrapper">
    ...
    <div id="rightcolumn"> 
        <div class = "content">
            ...
            <table>
                <tr>
                    <td><input type="checkbox"  id = "dollar" onclick="checkbox1()"></td>
                    <th>Total dollar sales by products</th>
                </tr>
                <tr>
                    <td><input type="checkbox" id = "quantity" onclick = "checkbox2()"></td>
